...
const PopularServices = ({servicesPromise}) => {
  ...
  return (
    <div className="pt-8">
        ...
        <div className="grid grid-cols-1 @min-[712px]:grid-cols-2 @min-[1180px]:grid-cols-3 @min-[1462px]:grid-cols-4 gap-4 sm:gap-7 md:gap-5 lg:gap-7 xl:gap-6 2xl:gap-7">
            {
